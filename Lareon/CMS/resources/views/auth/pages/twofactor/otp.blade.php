<section class="w-3/4">
    ...
    <form method="POST" action="" class="formAction">
        ...
        <div class="mb-3">
            <div class="flex items-center border border-zinc-300 rounded">
                <x-input.label for="sent_code" :value="__('code')" class="flex flex-col justify-center items-center !mb-0 p-3 text-white border-e border-zinc-300"/>
