...
<div class="mb-3" xmlns:x-lareon="http://www.w3.org/1999/html">
    ...
    @if($preview)
        <img id="pre-{{$random}}" src="{{$value ?? $data['src']}}" alt="{{$value}}" loading="lazy" fetchpriority="low" decoding="async" width="{{$data['width']}}" height="{{$data['height']}}" class="w-full max-w-full">
    @endif
